...
<html>
    ...
    <body>
        ...
        <div id="home" class="slider">
            ...
            <input type="radio" name="choose" id="choose_1" class="choose_1">
            <input type="radio" name="choose" id="choose_2" class="choose_2">
            <input type="radio" name="choose" id="choose_3" class="choose_3">

            <div class="slides">
                <a href="http://www.mobilelegends.com" target="_blank" rel="noopener noreferrer" class="slide s1">
                    <img src="images/slide-1.jpg" alt="Mobile Legends">
                </a>
                <a href="https://ff.garena.com/id/" target="_blank" rel="noopener noreferrer" class="slide s2">
                    <img src="images/slide-2.jpg" alt="Free Fire">
                </a>
                <a href="https://pubg.com/en/main" target="_blank" rel="noopener noreferrer" class="slide s3">
                    <img src="images/slide-3.jpg" alt="PUBG Mobile">
                </a>
            </div>
        </div>
        ...
        <section id="populer" class="populer">
            ...
            <?php foreach ($products as $name => $details): ?>
                <?php $id = strtolower(str_replace(' ', '', $name)); ?>
                <div class="<?= $id; ?>">
                    <div class="link">
                        <a href="#harga-<?= $id; ?>">
                        ...
                        <div class="popup">
                            ...
                            <div class="content">
                                <?php foreach ($details['prices'] as $item => $price): ?>
                                    <?= $item; ?>:<br><span class="harga"><?= $price; ?></span><br>
                                <?php endforeach; ?>
        ...
        <section class="tentang" id="tentang">
            <div class="card">
                ...
                <br>
                <p>
                    <a href="/" class="title">LAPAK JORIP</a> adalah website yang menyediakan layanan top up game.
                </p>
            </div>
        </section>
        ...
        <footer>
            <section class="sosmed" id="sosmed">
                <div class="sosmed">
                    <h1>SOSIAL MEDIA</h1>
                    <a href="https://instagram.com/zorivuu" target="_blank" rel="noopener noreferrer"><img src="./images/ig.png" alt="Instagram"></a>
                    <a href="http://facebook.com/zhorif.zaidaan" target="_blank" rel="noopener noreferrer"><img src="./images/fb.png" alt="Facebook"></a>
                    <a href="http://github.com/zorifff" target="_blank" rel="noopener noreferrer"><img src="./images/github.png" alt="GitHub"></a>
                </div>
            </section>
        </footer>
    </body>
